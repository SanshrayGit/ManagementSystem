...
cur=con.cursor()
print("---------------STARTING GIFTSLANE MANAGEMENT SYSTEM---------------")
import datetime
import time
...
def pcms(x):
    ...
    print('     __ ___                      __________  ______   ______                                                                 ______      ______                ______            __________ ')
    time.sleep(x)
    print('   |           /\      |\     |      |      |        |         |\     |       |\      /|      /\      |\     |      /\      |           |          |\      /| |         |\     |      |     ')
    time.sleep(x)
    print('   |          /  \     | \    |      |      |        |         | \    |       | \    / |     /  \     | \    |     /  \     |           |          | \    / | |         | \    |      |     ')
...
def createdb():
    ...
    cur.execute("CREATE DATABASE giftslaneDB")
    cur.execute("USE giftslaneDB")
...
def conn():
    try:
        ...
        createdb()
#####################################################################################################################################################################
print("WELCOME TO GIFTSLANE !!!! THE BEST GIFT SHOP")
conn()
#pcms(0.2)
main_menu()
